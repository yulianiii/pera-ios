...
//   AnyToNoAuthRekeyedAccountInformationScreen.swift
...
final class AnyToNoAuthRekeyedAccountInformationScreen:
    ...
    private lazy var theme = AnyToNoAuthRekeyedAccountInformationScreenTheme()
...
extension AnyToNoAuthRekeyedAccountInformationScreen {
    ...
    private func bindAccountTypeInformation() {
        let viewModel = AnyToNoAuthRekeyedAccountTypeInformationViewModel()
