...
//   AlgorandSecureBackupImportSuccessHeaderViewModel.swift

import Foundation
import MacaroonUIKit

struct AlgorandSecureBackupImportSuccessHeaderViewModel: NoContentViewModel {
    var icon: Image?
...
extension AlgorandSecureBackupImportSuccessHeaderViewModel {
