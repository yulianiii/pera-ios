...
//   OptOutAssetListItemCellTheme.swift

import Foundation
import MacaroonUIKit
import UIKit

struct OptOutAssetListItemCellTheme:
    StyleSheet,
    LayoutSheet {
    var context: OptOutAssetListItemViewTheme
    ...
    init(_ family: LayoutFamily) {
        self.context = OptOutAssetListItemViewTheme(family)
