...
//   BackUpAccountSelectionListLayout.swift

import Foundation
import UIKit
import MacaroonUIKit

final class BackUpAccountSelectionListLayout: AccountSelectionListLayout {
    typealias ListDataSource = BackUpAccountSelectionListDataSource.DataSource
    ...
    init(
        ...
        itemDataSource: BackUpAccountSelectionListItemDataSource
    ) {
...
extension BackUpAccountSelectionListLayout {
    private func listView(
        _ listView: UICollectionView,
        layout listViewLayout: UICollectionViewLayout,
        sizeForEmptyItem item: BackUpAccountSelectionListEmptyItemIdentifier,
    ...
    private func listView(
        ...
        let sizeCacheIdentifier = BackUpAccountSelectionListAccountListItemCell.reuseIdentifier
        ...
        let newSize = BackUpAccountSelectionListAccountListItemCell.calculatePreferredSize(
            sampleAccountItem,
            for: BackUpAccountSelectionListAccountListItemCell.theme.context,
    ...
    private func listView(
        _ listView: UICollectionView,
        sizeForHeaderItem item: BackUpAccountSelectionListHeaderViewModel,
        atSection section: Int
    ) -> CGSize {
        let sizeCacheIdentifier = BackUpAccountSelectionListHeader.reuseIdentifier
        ...
        let newSize = BackUpAccountSelectionListHeader.calculatePreferredSize(
            item,
            for: BackUpAccountSelectionListHeader.theme,
            fittingIn: CGSize((width, .greatestFiniteMagnitude))
        )
