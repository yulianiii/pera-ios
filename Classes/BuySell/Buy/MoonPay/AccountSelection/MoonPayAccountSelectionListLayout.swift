...
//   MoonPayAccountSelectionListLayout.swift

import Foundation
import UIKit
import MacaroonUIKit

final class MoonPayAccountSelectionListLayout: AccountSelectionListLayout {
    typealias ListDataSource = MoonPayAccountSelectionListDataSource.DataSource
    ...
    init(
        ...
        itemDataSource: MoonPayAccountSelectionListItemDataSource
    ) {
...
extension MoonPayAccountSelectionListLayout {
    private func listView(
        _ listView: UICollectionView,
        layout listViewLayout: UICollectionViewLayout,
        sizeForEmptyItem item: MoonPayAccountSelectionListEmptyItemIdentifier,
    ...
    private func listView(
        ...
        let sizeCacheIdentifier = MoonPayAccountSelectionListAccountListItemCell.reuseIdentifier
        ...
        let newSize = MoonPayAccountSelectionListAccountListItemCell.calculatePreferredSize(
            sampleAccountItem,
            for: MoonPayAccountSelectionListAccountListItemCell.theme.context,
    ...
    private func listView(
        _ listView: UICollectionView,
        sizeForHeaderItem item: MoonPayAccountSelectionListHeaderViewModel,
        atSection section: Int
    ) -> CGSize {
        let sizeCacheIdentifier = MoonPayAccountSelectionListHeader.reuseIdentifier
        ...
        let newSize = MoonPayAccountSelectionListHeader.calculatePreferredSize(
            item,
            for: MoonPayAccountSelectionListHeader.theme,
            fittingIn: CGSize((width, .greatestFiniteMagnitude))
        )
