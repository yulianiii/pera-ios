...
//   CollectibleDetailCreatorAccountItemCell.swift

import UIKit
import MacaroonUIKit

final class CollectibleDetailCreatorAccountItemCell:
    ...
    static let theme = CollectibleDetailCreatorAccountItemCellTheme()
