...
//   CollectibleAscendingOptedInRoundAlgorithm.swift

import Foundation

struct CollectibleAscendingOptedInRoundAlgorithm: CollectibleSortingAlgorithm {
    let id: String
    let name: String
...
extension CollectibleAscendingOptedInRoundAlgorithm {
    func getFormula(
