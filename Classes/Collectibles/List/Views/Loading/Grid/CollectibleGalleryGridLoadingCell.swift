...
//   CollectibleGalleryGridLoadingCell.swift

import Foundation
import MacaroonUIKit
import UIKit

final class CollectibleGalleryGridLoadingCell:
    CollectionCell<CollectibleGalleryGridLoadingView> {
    static let theme = CollectibleGalleryGridLoadingViewTheme()
...
extension CollectibleGalleryGridLoadingCell {
