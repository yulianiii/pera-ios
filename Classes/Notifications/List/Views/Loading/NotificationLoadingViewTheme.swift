...
//   NotificationLoadingViewTheme.swift

import Foundation
import MacaroonUIKit

protocol NotificationLoadingViewTheme:
    StyleSheet,
    LayoutSheet {
    var imageViewCorner: LayoutMetric { get }
    var imageViewSize: LayoutSize { get }
    var imageViewMargin: LayoutMargins { get }

    var titleViewCorner: LayoutMetric { get }
    var titleViewHeight: LayoutMetric { get }
    ...
    var supplementaryViewMargin: LayoutMargins { get }
}
