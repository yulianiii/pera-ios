...
//   OptOutAssetScreen.swift

import UIKit
import MacaroonUIKit
import MacaroonBottomSheet

final class OptOutAssetScreen:
    ScrollScreen,
    ...
    private let theme: OptOutAssetScreenTheme
    private let draft: OptOutAssetDraft
    ...
    override func bindData() {
        ...
        let viewModel = OptOutAssetViewModel(draft: draft)
