...
//   PendingTransactionItemDraftComposer.swift

import Foundation

struct PendingTransactionItemDraftComposer: TransactionListItemDraftComposer {
    ...
    func composeTransactionItemPresentationDraft(
        ...
        guard let transaction = transaction as? PendingTransaction else {
            return nil
        }
        ...
        let address = transaction.receiver == draft.accountHandle.value.address ? transaction.sender : transaction.receiver
