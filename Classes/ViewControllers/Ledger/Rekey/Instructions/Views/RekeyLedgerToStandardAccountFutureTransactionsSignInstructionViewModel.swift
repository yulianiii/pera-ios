...
//   RekeyLedgerToStandardAccountFutureTransactionsSignInstructionViewModel.swift

import Foundation
import MacaroonUIKit

struct RekeyLedgerToStandardAccountFutureTransactionsSignInstructionViewModel: InstructionItemViewModel {
