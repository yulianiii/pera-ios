...
//   RekeyLedgerToStandardAccountNoLongerRequiredToSignInstructionViewModel.swift

import Foundation
import MacaroonUIKit

struct RekeyLedgerToStandardAccountNoLongerRequiredToSignInstructionViewModel: InstructionItemViewModel {
