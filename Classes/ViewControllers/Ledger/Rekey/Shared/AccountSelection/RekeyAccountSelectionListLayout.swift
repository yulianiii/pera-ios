...
//   RekeyAccountSelectionListLayout.swift

import Foundation
import UIKit
import MacaroonUIKit

final class RekeyAccountSelectionListLayout: AccountSelectionListLayout {
    typealias ListDataSource = RekeyAccountSelectionListDataSource.DataSource
    ...
    init(
        ...
        itemDataSource: RekeyAccountSelectionListItemDataSource
    ) {
...
extension RekeyAccountSelectionListLayout {
    private func listView(
        _ listView: UICollectionView,
        layout listViewLayout: UICollectionViewLayout,
        sizeForEmptyItem item: RekeyAccountSelectionListEmptyItemIdentifier,
    ...
    private func listView(
        ...
        let sizeCacheIdentifier = RekeyAccountSelectionListAccountListItemCell.reuseIdentifier
        ...
        let newSize = RekeyAccountSelectionListAccountListItemCell.calculatePreferredSize(
            sampleAccountItem,
            for: RekeyAccountSelectionListAccountListItemCell.theme.context,
    ...
    private func listView(
        _ listView: UICollectionView,
        sizeForHeaderItem item: RekeyAccountSelectionListHeaderViewModel,
        atSection section: Int
    ) -> CGSize {
        let sizeCacheIdentifier = RekeyAccountSelectionListHeader.reuseIdentifier
        ...
        let newSize = RekeyAccountSelectionListHeader.calculatePreferredSize(
            item,
            for: RekeyAccountSelectionListHeader.theme,
            fittingIn: CGSize((width, .greatestFiniteMagnitude))
        )
