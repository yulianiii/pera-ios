...
// skipped method TransactionSignerArray.GetSignerItem with unsupported parameter or return types

// skipped method TransactionSignerArray.GetSignerItems with unsupported parameter or return types
...
- (nonnull instancetype)initWithRef:(_Nonnull id)ref;
- (nonnull instancetype)init;
- (NSString* _Nonnull)getSigner;
- (NSData* _Nullable)getTransaction;
@end
...
FOUNDATION_EXPORT NSString* _Nonnull AlgoSdkBackupMnemonicFromKey(NSData* _Nullable key, NSError* _Nullable* _Nullable error);

FOUNDATION_EXPORT NSData* _Nullable AlgoSdkBackupMnemonicToKey(NSString* _Nullable mnemonic, NSError* _Nullable* _Nullable error);

// skipped function ConvertUInt64ToInt64 with unsupported parameter or return types


// skipped function DecodeAddress with unsupported parameter or return types
...
FOUNDATION_EXPORT NSData* _Nullable AlgoSdkGenerateBackupCipherKey(NSString* _Nullable key, NSData* _Nullable input);

FOUNDATION_EXPORT NSData* _Nullable AlgoSdkGenerateBackupPrivateKey(void);
...
// skipped function MakeAppBoxRefArray with unsupported parameter or return types
 ...
 */
FOUNDATION_EXPORT NSString* _Nonnull AlgoSdkMethodName(NSString* _Nullable text);
